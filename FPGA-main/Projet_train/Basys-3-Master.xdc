...
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {sortie_dcc_top}]
	set_property IOSTANDARD LVCMOS33 [get_ports {sortie_dcc_top}]
##Sch name = JB7
#set_property PACKAGE_PIN A15 [get_ports {sortie_dcc_top}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {sortie_dcc_top}]
##Sch name = JB8
